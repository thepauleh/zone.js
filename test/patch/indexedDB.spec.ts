        ...
        it('should bind EventTarget.addEventListener', function(done) {
          ...
          testZone.run(function() {
            ...
            Zone.root.run(() => {
              ...
              console.log(
                  'eventListeners eventName ', req['__zone_symbol__eventTasks'][0].data.eventName);
            });
          });
          ...
          testZone.run(function() {
            ...
            Zone.root.run(() => {
              ...
              console.log(
                  ...
                  req['__zone_symbol__eventTasks'][0].data.handler.toString());
              console.log(
                  'eventListeners eventName onsuccess',
                  req['__zone_symbol__eventTasks'][0].data.eventName);
            });
          });
        });
      });
