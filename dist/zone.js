 ...
 * found in the LICENSE file at https://angular.io/license
 */
Zone.__load_patch('mediasource', function (global, Zone, api) {
    if (!global['MediaSource']) {
        return;
    }
    var eventTargetAddEventListener = EventTarget.prototype.addEventListener;
    api.patchMethod(global['MediaSource'], 'addSourceBuffer', function (delegate, delegateName, name) {
        return function (self, args) {
            var sourceBuffer = delegate.apply(self, args);
            if (sourceBuffer) {
